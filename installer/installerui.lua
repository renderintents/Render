    ...
    function api:createwindow(userdata: table)
        ...
        local guiapi = {tabs = {}, buttons = {}, definitions = {}, settings = {}, recycle = {}, type = 'window'};
    ...
    function api:createbutton(userdata: table)
        ...
        local buttonapi = {enabled = false, definitions = {}, type = 'button'};
        ...
        api.window.buttons[buttontext.Text] = buttonapi;
        return buttonapi
    end
