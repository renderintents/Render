...
local api = isfile('rendervape/installer/installerui.lua') and loadfile('rendervape/installer/installerui.lua')() or loadstring(getasync('https://storage.renderintents.lol/installer/installerui.lua?ria='..ria))();
